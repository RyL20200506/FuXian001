% 洛伦兹混沌 求解参数的动力学
% fun_9: 与之前的区别在于, 
function ret = fun_9_lorenz_solver_origin(t,Y, FXdot, FX)
...
% 误差梯度动力学 感觉无误
-alpha*Y(23)+(-2)*( dot_x - (Y(25)*(Y(5)-x)) )*Y(25)*Y(13)+2*beta* (-2*gamma * Y(23));
-alpha*Y(24)+(-2)*( dot_x - (Y(25)*(Y(5)-x)) )*Y(25)*Y(14)+2*beta* (-2*gamma * Y(24));
