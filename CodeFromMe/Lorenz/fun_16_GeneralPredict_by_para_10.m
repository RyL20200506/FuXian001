...
function [future_values] = fun_16_GeneralPredict_by_para_10(history, predict_start_point, predict_length)
    % 输入参数: history - 历史数据
...
%     end
    ...
    base = fun_16_baseEuqation1_with_para_10(history(1:end-1,:))';
    BASE = [base*t0, base*t0^2, base*t0^3, base*t0^4];
    ...
    for i = 1: predict_length
        ...
        a_base = fun_16_baseEuqation1_with_para_10(a_future)';
        a_BASE = [a_base * t0, a_base * t0^2, a_base * t0^3, a_base * t0^4];
